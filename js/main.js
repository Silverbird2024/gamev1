...
$scope.Card12_click = function() {$scope.GotoPage( "Page01" );};
$scope.Card09_click = function() {$scope.GotoPage( "Page09" );};
$scope.Card08_click = function() {$scope.GotoPage( "Page09" );};
...
$scope.TextArea43_change = function() {localStorage.setItem("Title04a",$App.Title04a);};
$scope.TextArea44_change = function() {localStorage.setItem("Title04b",$App.Title04b);};
$scope.TextArea45_change = function() {localStorage.setItem("Title04d",$App.Title04d);};
$scope.TextArea46_change = function() {localStorage.setItem("Title04c",$App.Title04c);};
$scope.PushButton114_click = function() {neoTalkSpeak($App.Title04a, "uk", 1, .9);};
$scope.PushButton115_click = function() {neoTalkCancelSpeech();};
$scope.PushButton116_click = function() {neoTalkSpeak($App.Title04b, "uk", 1, .9);};
$scope.PushButton117_click = function() {neoTalkCancelSpeech();};
$scope.PushButton118_click = function() {neoTalkSpeak($App.Title04c, "uk", 1, .9);};
...
$scope.TextArea18_change = function() {localStorage.setItem("Title07a",$App.Title07a);};
...
$scope.TextArea23_change = function() {localStorage.setItem("Title07d",$App.Title07d);};
});
NeoApp.controller("EndBufferPage1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 15;
$App.NAB.PageID = "EndBufferPage1";
});
