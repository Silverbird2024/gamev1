...
$scope.SetObjectStyle("Container26","border-left-color","Green");
$scope.SetObjectStyle("Container26","border-right-color","Green");};
$scope.Container20_click = function() {$scope.GotoPage( "Page20-100" );};
...
$scope.PushButton91_click = function() {neoTalkSpeak($App.Title01b, "uk", 1, .9);};
$scope.PushButton92_click = function() {neoTalkCancelSpeech();};
$scope.PushButton95_click = function() {neoTalkSpeak($App.Title01c, "uk", 1, .9);};
$scope.PushButton96_click = function() {neoTalkCancelSpeech();};
});
NeoApp.controller("P1Template2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "P1Template2";
$scope.PushButton72_click = function() {$scope.GotoPage( "MainBoard" );};
$scope.TextArea24_change = function() {localStorage.setItem("Title01a",$App.Title01a);};
$scope.TextArea25_change = function() {localStorage.setItem("Title01b",$App.Title01b);};
$scope.TextArea26_change = function() {localStorage.setItem("Title01d",$App.Title01d);};
$scope.PushButton74_click = function() {$scope.GotoPage( "P1Template2" );};
$scope.PushButton81_click = function() {$scope.GotoPage( "P1Template3" );};
$scope.TextArea30_change = function() {localStorage.setItem("Title01c",$App.Title01c);};
$scope.TextArea31_change = function() {localStorage.setItem("Title01e",$App.Title01e);};
});
NeoApp.controller("P1Template3_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "P1Template3";
$scope.PushButton75_click = function() {$scope.GotoPage( "MainBoard" );};
$scope.TextArea27_change = function() {localStorage.setItem("Title01a",$App.Title01a);};
$scope.TextArea28_change = function() {localStorage.setItem("Title01b",$App.Title01b);};
$scope.TextArea29_change = function() {localStorage.setItem("Title01d",$App.Title01d);};
$scope.PushButton77_click = function() {$scope.GotoPage( "P1Template2" );};
$scope.PushButton82_click = function() {$scope.GotoPage( "P1Template3" );};
$scope.TextArea32_change = function() {localStorage.setItem("Title01e",$App.Title01e);};
});
...
$scope.PushButton97_click = function() {neoTalkSpeak($App.Title03a, "uk", 1, .9);};
$scope.PushButton98_click = function() {neoTalkCancelSpeech();};
$scope.PushButton99_click = function() {neoTalkSpeak($App.Title03b, "uk", 1, .9);};
$scope.PushButton100_click = function() {neoTalkCancelSpeech();};
$scope.PushButton101_click = function() {neoTalkSpeak($App.Title03c, "uk", 1, .9);};
...
$scope.PushButton103_click = function() {neoTalkSpeak($App.Title04a, "uk", 1, .9);};
$scope.PushButton104_click = function() {neoTalkCancelSpeech();};
$scope.PushButton105_click = function() {neoTalkSpeak($App.Title04b, "uk", 1, .9);};
$scope.PushButton106_click = function() {neoTalkCancelSpeech();};
$scope.PushButton107_click = function() {neoTalkSpeak($App.Title04c, "uk", 1, .9);};
...
$scope.PushButton123_click = function() {neoTalkSpeak($App.Title05a, "uk", 1, .9);};
...
$scope.PushButton127_click = function() {neoTalkSpeak($App.Title05c, "uk", 1, .9);};
$scope.PushButton128_click = function() {neoTalkCancelSpeech();};
});
NeoApp.controller("Page20-100_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "Page20-100";
...
$scope.PushButton132_click = function() {neoTalkSpeak($App.Title06a, "uk", 1, .9);};
...
$scope.PushButton136_click = function() {neoTalkSpeak($App.Title06c, "uk", 1, .9);};
