...
$scope.Card05_click = function() {$scope.GotoPage( "Page01" );};
...
$scope.TextInput62_change = function() {localStorage.setItem("Title05d",$App.Title06d);};
